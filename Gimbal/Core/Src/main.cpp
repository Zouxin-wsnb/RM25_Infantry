...
void EnableSystickIT(void)
{
  ...
  uint32_t reload = SystemCoreClock / 8000 * tick_ms; // SystemCoreClock / 8000 * tick_ms;
...
int main(void)
{
  ...
  LED_ALL_ON();
  monitor->Monitor_RobotFinishInit();
  /* USER CODE END 2 */
