...
{
    if (id >= 0xB1 && id <= 0xB8) // 对于云台C板，发送的id范围为0xBx
    {
        id -= 0xB1;
    ...
    else if (id >= 0xC1 && id <= 0xC8) // 对于云台C板，接受的id范围为0xCx
    {
        id -= 0xC1;
