#ifndef SHOOTER_STATE_FIRE_HPP
#define SHOOTER_STATE_FIRE_HPP
...
/**
 * @class ShooterStateFire
 * @brief 云台放松状态机，电机不动。
 * @note 云台放松状态机继承自状态机基类。
 */
class ShooterStateFire : public State
{
public:
    ShooterStateFire(GM3508 *LeftFricMotor,
